...
WebUI.click(findTestObject('parts/Page_Z2DATA Web Administration (10)/a_Families with ProductsLine'))

WebUI.verifyTextPresent('Family Summary with Products', false)
